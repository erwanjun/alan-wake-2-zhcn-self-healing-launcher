...
namespace alan_wake_2_rmdtoc_Tool
{
    ...
    public class FileInfo
    {
        ...
        public void SetFile()
        {
            ...
            // RMDBLOBs can exceed 4 GiB. BufferOffset stores a 40-bit value split
            // between _bufferoffset and unko3, so truncating Position to Int32
            // corrupts appended entries once a blob grows past 0x7fffffff.
            info.BufferOffset = stream.Position;
    ...
    public class rmdtoc : IDisposable
    {
        ...
        public void Save()
        {
            ...
            var infoTable = CompressFile(BufferStream.ToArray(), out CompressedBytes);
