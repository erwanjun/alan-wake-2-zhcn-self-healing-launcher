...
namespace Helper
{
    ...
    public class FStream : FileStream, IStream
    {
        ...
        #region String
        public string GetStringValue(int StringLenght, Encoding encoding) { return GetStringValue(StringLenght, true, -1, encoding); }
        public string GetStringValue(int StringLenght, bool SavePosition, Encoding encoding) { return GetStringValue(StringLenght, SavePosition, -1, encoding); }
